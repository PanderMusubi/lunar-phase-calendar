...
First, choose the ICS calendar file on GitHub you would like to add to your calendar software. Browse under Code to e.g. `GB/en` and choose e.g. `full-moon.ics`. Then, click on the button called Raw and you will go to the URL for this calendar. To automatically add the URL in calendar software, click on for this example [webcal://raw.githubusercontent.com/PanderMusubi/lunar-phase-calendar/master/GB/en/full-moon.ics](webcal://raw.githubusercontent.com/PanderMusubi/lunar-phase-calendar/master/GB/en/full-moon.ics) or copy paste `https://raw.githubusercontent.com/PanderMusubi/lunar-phase-calendar/master/GB/en/full-moon.ics`.
